...
class UpdateTeacher implements ActionListener{
    ...
    UpdateTeacher(){
        sf=new JFrame("Update Teacher details");
        sf.setSize(900,650);
        sf.setLocation(450,150); 
        sf.setBackground(Color.white);
        sf.setLayout(null);

        JLabel sl1 = new JLabel("Enter Teacher ID to update the data of teacher");
        ...
        sid8 = new JLabel("Update Teacher Details:");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==sb){
            try{
                conn scon = new conn();
                String str = "update teacher set name='"+st1.getText()+"',fathers_name='"+st2.getText()+"',age='"+st3.getText()+"', dob='"+st4.getText()+"',address='"+st5.getText()+"',phone='"+st6.getText()+"',email='"+st7.getText()+"',class_x='"+st8.getText()+"',class_xii='"+st9.getText()+"',aadhar='"+st10.getText()+"', emp_id = '"+st11.getText()+"',course='"+st13.getText()+"',dept='"+st14.getText()+"' where emp_id='"+st12.getText()+"'";
                scon.s.executeUpdate(str);
        ...
        if(ae.getSource() == sb2){
            try{
                conn con = new conn();
                String str = "select * from teacher where emp_id = '"+st12.getText()+"'";
